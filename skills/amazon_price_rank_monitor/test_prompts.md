# Test Prompts For `amazon_price_rank_monitor`

## Basic Sanity Tests

1. Load `amazon_price_rank_monitor` and summarize what it does.
2. Create a minimal valid input using `asins` and `products`.
