# Test Prompts For `google_maps_lead_scraper`

## Basic Sanity Tests

1. Load `google_maps_lead_scraper` and summarize what it does.
2. Create a minimal valid input using `searchQueries` and `searchQueriesText`.
