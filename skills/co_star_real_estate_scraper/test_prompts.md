# Test Prompts For `co_star_real_estate_scraper`

## Basic Sanity Tests

1. Load `co_star_real_estate_scraper` and summarize what it does.
2. Create a minimal valid input using `startUrls` and `maxItems`.
