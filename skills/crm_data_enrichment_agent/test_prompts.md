# Test Prompts For `crm_data_enrichment_agent`

## Basic Sanity Tests

1. Load `crm_data_enrichment_agent` and summarize what it does.
2. Create a minimal valid input using `contactsSource`.
